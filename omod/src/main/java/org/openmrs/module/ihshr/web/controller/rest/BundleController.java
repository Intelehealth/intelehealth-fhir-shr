...
import org.openmrs.module.ihshr.service.BundleService;
...
public class BundleController {
	...
	public ResponseEntity<?> getResource(@PathVariable String resourceType, @RequestParam Map<String, String> reqParam)
		...
		BundleService bundleService = Context.getRegisteredComponent("ihshrBundleService", BundleService.class);
